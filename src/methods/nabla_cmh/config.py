...
HYPERPARAMETERS = {
    ...
    "words": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 100, "lr": 0.061465365203332685, "lambd": 0.016586187301588867, 
                                     "promising_action_coeffs": [0.13490116, 0.75363674, 0.04343645, 0.06802565]},
            }
        }
    },
    ...
    "vote": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 100, "lr": 0.025856643751441536, "lambd": 1.8520064080886105, 
                                     "promising_action_coeffs": [0.2331782 , 0.02110202, 0.45213348, 0.2935863]},
            }
        }
    },
    ...
    "pow": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 150, "lr": 0.001443332231672988, "lambd": 0.4221961640003871, 
                                     "promising_action_coeffs": [0.47597907, 0.20892607, 0.15663724, 0.15845762]},
            }
        }
    },
