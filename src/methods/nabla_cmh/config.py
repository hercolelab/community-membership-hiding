...
HYPERPARAMETERS = {
    "kar": {
        "training_greedy": {
            "tau_0.5": {
                    ...
                    "betaFactor_1": {"T": 120, "lr": 0.07983426583390857, "lambd": 1.718469437702412, 
                                     "promising_action_coeffs": [0.33704471, 0.20279257, 0.21260506, 0.24755767]},
        ...
        "training_leiden": {
            "tau_0.5": {
                "betaFactor_1": {"T": 140, "lr": 0.07417416468608282, "lambd": 1.5878028066924788, 
                                    "promising_action_coeffs": [0.10375311, 0.06853599, 0.58745126, 0.24025964]},
            }
        }
    },
    ...
    "words": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 150, "lr": 0.062208303433574245, "lambd": 3.8236741730468866, 
                                     "promising_action_coeffs": [0.06069416, 0.84911535, 0.02231174, 0.06787875]},
            }
        }
    },
    ...
    "vote": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 130, "lr": 0.05233032652042715, "lambd": 0.4917761212745024, 
                                     "promising_action_coeffs": [0.31316699, 0.24533087, 0.10798629, 0.33351585]},
            }
        }
    },
    ...
    "pow": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 140, "lr": 0.0016129308883644194, "lambd": 14.100342828915029, 
                                     "promising_action_coeffs": [0.17293187, 0.6132423 , 0.05662542, 0.15720042]},
            }
        }
    },
    ...
    "fb-75": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 90, "lr": 0.44179466168177534, "lambd": 0.012107158461342598, 
                                     "promising_action_coeffs": [0.06872267, 0.24947369, 0.66553282, 0.01627081]},
            }
        }
    },
    ...
    "cond-mat": {
        ...
        "training_leiden": {
            "tau_0.5": {
                    "betaFactor_1": {"T": 130, "lr": 0.0014001447695145286, "lambd": 0.3861209748857342, 
                                     "promising_action_coeffs": [0.34655773, 0.15514453, 0.20669213, 0.2916056 ]},
            }
        }
    }
}
